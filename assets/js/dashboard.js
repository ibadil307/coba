...
$(window).on('load', function () {
    ...
    var progressCirclesblue1 = new ProgressBar.Circle(circleprogressblue1, {
        ...
        step: function (state, circle) {
            ...
            if (value === 0) {
                ...
                circle.setText(value + "<small class='text-secondary'>%<small>");
            }
    ...
    progressCirclesyellow1.text.style.fontSize = '24px';
    ...
    var progressCirclesred1 = new ProgressBar.Circle(circleprogressred1, {
        ...
        trailWidth: 10,
        easing: 'easeInOut',
        trailColor: 'rgba(221, 39, 57,  0.15)',
        duration: 1400,
        text: {
            autoStyleContainer: false
        },
    ...
    progressCirclesred1.text.style.fontSize = '24px';
    ...
    progressCirclesblue2.text.style.fontSize = '18px';
    progressCirclesblue2.animate(0.12);  // Number from 0.0 to 1.0
    ...
    var progressCirclesgreen2 = new ProgressBar.Circle(circleprogressgreen2, {
        ...
        trailWidth: 10,
        easing: 'easeInOut',
        trailColor: 'rgba(13, 175, 120, 0.15)',
        duration: 1400,
        text: {
            autoStyleContainer: false
        },
        from: { color: '#0daf79', width: 10 },
        to: { color: '#0daf79', width: 10 },
        // Set default step function for all animate calls
        step: function (state, circle) {
            circle.path.setAttribute('stroke', state.color);
            circle.path.setAttribute('stroke-width', state.width);
    ...
    progressCirclesgreen2.text.style.fontSize = '18px';
    progressCirclesgreen2.animate(0.40);  // Number from 0.0 to 1.0

    /* circular progress */
    var progressCirclesyellow2 = new ProgressBar.Circle(circleprogressyellow2, {
        color: '#E50A8E',
        // This has to be the same size as the maximum width to
        // prevent clipping
        strokeWidth: 10,
    ...
    progressCirclesyellow2.text.style.fontSize = '18px';
    progressCirclesyellow2.animate(0.28);  // Number from 0.0 to 1.0

    /* circular progress */
    var progressCirclesred2 = new ProgressBar.Circle(circleprogressred2, {
        color: '#dd2739',
        // This has to be the same size as the maximum width to
        // prevent clipping
        strokeWidth: 10,
    ...
    progressCirclesred2.text.style.fontSize = '18px';
    progressCirclesred2.animate(0.20);  // Number from 0.0 to 1.0
    ...
    progressCirclesblue3.text.style.fontSize = '18px';
    progressCirclesblue3.animate(0.12);  // Number from 0.0 to 1.0
    ...
    var areachartred = document.getElementById('areachartred2').getContext('2d');
    ...
    gradientgreen.addColorStop(0, 'rgba(13, 175, 120, 0.85)');
    gradientgreen.addColorStop(1, 'rgba(13, 175, 120, 0)');
    ...
    var areachartyellow = document.getElementById('areachartyellow2').getContext('2d');
